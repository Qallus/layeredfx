"use client";
import {StudioJobs} from '@/components/operations/studio-leads';
...
export function JobsPage(){return <SourceScreen><StudioJobs/><JobsListClient initialRows={[]} types={types} groups={[]} report={computeJobReport([],new Date().toISOString().slice(0,10))}/></SourceScreen>;}
