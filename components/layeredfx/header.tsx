...
const links = [{ label: "Our services", href: "/#services" }, { label: "Inspiration", href: "#inspiration" }, { label: "Our approach", href: "#approach" }, { label: "Design studio", href: "#studio" }, { label: "Book a consultation", href: "/book" }, { label: "Contact", href: "/contact" }];
