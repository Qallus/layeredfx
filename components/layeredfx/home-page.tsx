...
export function LayeredFXHome() {
  return <EstimateProvider><div className="lfx" id="top"><a className="lfx-skip" href="#main">Skip to content</a><Header /><main id="main">
    <Hero />
