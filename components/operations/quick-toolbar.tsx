...
function ToolBody({tool,deal,caps,readOnly,onDone}:{tool:ToolId;deal?:Deal;caps:Capabilities;readOnly:boolean;onDone:()=>void}){
 ...
 switch(tool){
  ...
  case 'agent':return <div className="ops-quick-tool"><p>Open your agent workspace to review skills and conversations.</p><p className="ops-muted">Agent execution still requires the LayeredFX AI provider integration.</p><div className="ops-actions"><Button asChild><Link href="/admin/agent">Open AI Agents</Link></Button></div></div>;
