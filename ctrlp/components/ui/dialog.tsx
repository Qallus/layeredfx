// Adapted from CTRL+P 015a7b58b80e63ef87c73bec549a23242b88f3e3: components/ui/dialog.tsx
"use client";
...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>>(({ className, children, ...props }, ref) => (<DialogPortal container={typeof document === "undefined" ? undefined : document.querySelector(".ops")}>
    <DialogOverlay />
