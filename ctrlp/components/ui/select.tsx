// Adapted from CTRL+P 015a7b58b80e63ef87c73bec549a23242b88f3e3: components/ui/select.tsx
"use client";
...
const SelectContent = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Content>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content>>(({ className, children, ...props }, ref) => (<SelectPrimitive.Portal container={typeof document === "undefined" ? undefined : document.querySelector(".ops")}>
    <SelectPrimitive.Content ref={ref} position="popper" className={cn("relative z-[100] min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md", className)} {...props}>
