// Adapted from CTRL+P 015a7b58b80e63ef87c73bec549a23242b88f3e3: lib/admin/section-configs.ts
...
export const adminSectionConfigs = {
    analytics: {
        title: "Analytics",
        eyebrow: "Analytics",
        description: "Track revenue, order volume, production health, customer behavior, and operational trends across LayeredFX.",
