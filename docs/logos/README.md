...
- Dashboard sidebar uses the dark simple logo on its permanent dark surface. The top bar switches simple logos with the dashboard theme. Sign-in uses the light simple logo.
