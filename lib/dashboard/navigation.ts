import {LayoutDashboard,ChartNoAxesCombined,ShoppingBag,CalendarRange,Boxes,CalendarCheck,Palette,HardHat,CircleDollarSign,MessageSquare,Phone,Users,UserCog,PackageCheck,LayoutTemplate,Tag,FileText,Truck,Megaphone,BookOpen,Bot,Settings,UserRound,TrendingUp,ClipboardList,BriefcaseBusiness,IdCard,Contact,Store,type LucideIcon} from 'lucide-react';
...
export const dashboardNavigation:{label:string;items:DashboardNavItem[]}[]=[
 {label:'Main',items:[
  ...
  {label:'Projects',href:'/admin/production-schedule',icon:CalendarRange},{label:'Production',href:'/admin/production',icon:Boxes},{label:'Bookings',href:'/admin/bookings',icon:CalendarCheck},
  ...
  {label:'Portals',href:'/admin/portals',icon:Users},{label:'Workspace',href:'/admin/workspace',icon:FileText},
