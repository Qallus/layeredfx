...
export const inspiration = [
  { title: "A warmer welcome", kind: "residential", image: "/images/architectural-room-photo.png", description: "Soft texture · Natural tones", services: ["Roman clay", "Interior painting"] },
  { title: "A fresh perspective", kind: "residential", image: "/images/kitchen-photo.png", description: "Architectural wraps · Considered contrast", services: ["Cabinet wraps", "Countertop wraps"] },
  { title: "A space that speaks", kind: "commercial", image: "/images/window-film-photo.png", description: "Privacy film · Branded environments", services: ["Window tint & film", "Wall wraps"] },
];
export const faqs = [
