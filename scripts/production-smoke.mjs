...
try {
 ...
 for(const path of ['/','/images/kitchen.svg','/admin','/admin/coupons','/admin/orders','/admin/jobs','/admin/contacts','/admin/leads','/api/admin/coupons','/api/operations','/api/ctrlp/admin/orders','/api/ctrlp/cmi/jobs','/api/communications/capabilities','/api/communications/calls','/login','/register','/contact','/book','/studio','/api/portal','/api/portal/media','/api/portal/staff']) {
