-- Applied to LayeredFX Supabase (tdywcdgbavfcsywejoka) as layeredfx_business_cards. Source: docs/migration/sql/business-cards-review-draft.sql
-- (normalized from Channel Cast OS lib/business-cards), plus a covering index for changed_by.
-- Supersedes the single-table draft in .review/integration/docs/migrations/20260913-business-cards.sql.
...
create index lfx_business_cards_changed_by on public.lfx_business_cards(org_id, changed_by);
