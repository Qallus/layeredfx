-- Applied to LayeredFX Supabase (tdywcdgbavfcsywejoka) as layeredfx_coupons. Source: docs/migration/sql/coupons-review-draft.sql
-- (derived from CTRL+P 015a7b58 initial_schema.sql), plus a covering index for the changed_by foreign key.
...
create index lfx_coupons_changed_by on public.lfx_coupons(org_id,changed_by);
